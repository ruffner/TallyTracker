 ...
 */
public final class TallyTable {
    public static final String AUTHORITY = "com.bluntllama.provider.TallyTable";
     ...
     */
    public static final class Tally implements BaseColumns {
         ...
         */
        private static final String PATH_TALLYS = "/tallys";

        /**
         * Path part for the Note ID URI
         */
        private static final String PATH_TALLY_ID = "/tallys/";
         ...
         */
        public static final Uri CONTENT_URI =  Uri.parse(SCHEME + AUTHORITY + PATH_TALLYS);
        ...
        public static final Uri CONTENT_ID_URI_BASE
            = Uri.parse(SCHEME + AUTHORITY + PATH_TALLY_ID);
